...
export class ProductsService {
  ...
  productToCartSubject = new Subject<IProducts>();
  productFavSubject = new Subject<IProducts>();
  ...
  getProductById(id:number):IProducts{
    let prd:any = this.productList.find(n=>{
      return n.id == id;
    })
    return prd;
  }

  addNewProduct(product:IProducts):IProducts[]{
  ...
  addToCartProduct(product: IProducts) {
  ...
  addFavProduct(product: IProducts) {
    this.productFavSubject.next(product);
  }
  getFavProduct() {
    return this.productFavSubject.asObservable();
  }
